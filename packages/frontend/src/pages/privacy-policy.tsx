        ...
        <Box mx="auto">
          ...
          >
            <VStack alignItems="left" spacing="2.5">
              ...
              <Text>
                The Developer DAO Foundation, a Cayman Islands foundation
                company (including our subsidiaries, affiliates, and as governed
                by the Developer DAO Decentralized Autonomous Organization token
                holders, “we”, “us” or “our”) is responsible for your personal
                data.
              </Text>
              <Text>
            ...
            <VStack mt="2.5rem" alignItems="left">
              ...
              <OrderedList>
                <VStack spacing="2.5" mt="1.5rem">
                  <ListItem>
                    <Box as="span" fontWeight="bold">
                      The right to be informed.
                    </Box>
                    You have the right to be informed about how the Developer
                    DAO Foundation processes your personal data. Typically, the
                    Developer DAO Foundation communicates this information
                    through privacy notices such as this one.
                  </ListItem>
                  <ListItem>
                    <Box as="span" fontWeight="bold">
                      The right to data access.
                    </Box>
                    You have a right to obtain a copy of the personal data we
                  ...
                  <ListItem>
                    ...
                    personal data in specific circumstances. Where that is the
                    case, we may still store your information, but not use it
                    further.
                  </ListItem>
                  <ListItem>
                    <Box as="span" fontWeight="bold">
                    ...
                    structured, machine-readable format for your own purposes,
                    or to request us to share it with a third party.
                  </ListItem>
                  <ListItem>
                    <Box as="span" fontWeight="bold">
              ...
              <Text>
                In certain circumstances, we may need to restrict the above
                rights to safeguard the public interest (e.g., the prevention or
            ...
            <VStack mt="2.5rem" spacing="2.5" alignItems="left">
              ...
              <Text>
                ...
                right to withdraw this consent at any point. If you would like
                to withdraw consent for a particular type of data processing
                that the Developer DAO Foundation performs, please email the
                following address: developerdaooperations@gmail.com.
              </Text>
            </VStack>
            <VStack mt="2.5rem" spacing="2.5" alignItems="left">
              ...
              <Text>
                ...
                the purposes of direct marketing. In some circumstances we are
                legally obliged to share information. For example, under a court
                order. In any scenario, we will satisfy ourselves that we have a
                lawful basis on which to share the information and document our
                decision making and satisfy ourselves we have a legal basis on
            ...
            <VStack mt="2.5rem" spacing="2.5" alignItems="left">
              ...
              <Text>
                ...
                to protect personal data that we hold from unauthorised
                disclosure, use, alteration, or destruction. Where appropriate,
                we use encryption and other technologies that assist in securing
                the data you provide. We also require our service providers to
                comply with strict data privacy requirements where they process
                your personal data.
              </Text>
            </VStack>
            <VStack mt="2.5rem" spacing="2.5" alignItems="left">
              ...
              <Text>
                ...
                purposes described in this privacy notice, or until you notify
                us that you no longer wish us to process your data. After this
                time, we will securely delete your personal data, unless we are
                required to keep it to meet legal or regulatory obligations, or
            ...
            <VStack mt="2.5rem" spacing="2.5" alignItems="left">
              ...
              <Text>
                ...
                the Developer DAO Foundation at:
                developerdaooperations@gmail.com.
              </Text>
            </VStack>
            <VStack spacing="2.5" mt="2.5rem" alignItems="left">
              <Heading as="h2" fontSize="lg">
                MEMBERS OF STAFF AND CONTRACTORS WITH THE DEVELOPER DAO
                FOUNDATION
              </Heading>
              <Heading as="h3" fontSize="md">
              ...
              <UnorderedList>
                <VStack spacing="2.5" alignItems="left">
                  <ListItem>
                    human resources management including organization and
                    personal administration, working hours management, improving
                    and maintaining effective staff administration, internal
                    workforce analysis, reporting and planning;
                  </ListItem>
                  <ListItem>staff succession planning;</ListItem>
                  <ListItem>
                    compensation and benefits management and performance
                    reviews;
                  </ListItem>
                  <ListItem>
                    talent management and acquisition including recruitment,
                    assessing suitability and working capacity, background
                    checks and verification of qualifications, obtaining and
                  ...
                  <ListItem>
                    learning and development management including
                    certifications, training staff and performing assessments
                  ...
                  <ListItem>
                    carrying out the obligations and exercising specific rights
                    in the field of employment or a collective agreement;
                  </ListItem>
                  <ListItem>
                    internal and external communication of Developer DAO
                    Foundation’s organization and representation of The
                    Developer DAO Foundation including commercial register and
                  ...
                  <ListItem>
                    ...
                    and videos depicting employees or other individuals
                    available for download on the Developer DAO Foundation
                    website, etc.;
                  </ListItem>
                  <ListItem>
                  ...
                  <ListItem>
                    ...
                    remediation of crime and fraud or prohibited activities or
                    to otherwise protect legal rights and to establish, exercise
                    or defend legal claims;
                  </ListItem>
                  <ListItem>
                    managing the customer relationship, processing customer
                    orders and providing customer support, processing,
                    evaluating and responding to requests and inquiries;
                    managing the suppliers, contractors, advisers and other
                    professional experts including contact interaction,
                    processing and fulfilling purchases and invoices, and
                    contract lifecycle management;
                  </ListItem>
                  <ListItem>
                    making use of work performance and products and for
                    references on documents, such as drawings, purchase orders,
                    sales orders, invoices, reports;
                  </ListItem>
                  <ListItem>
                    maintaining and protecting the security of products,
                    facilities, services, systems, networks, computers, and
                    information, preventing, and detecting security threats,
                    fraud or other criminal or malicious activities, and
              ...
              <Text>
                ...
                purposes described above. Certain personal data collected from
                you relates to your next of kin and emergency contacts. In these
                cases, you are requested to inform such persons about this
                Notice.
              </Text>

              <Heading as="h3" fontSize="md">
                What happens if you do not provide us with the information we
                have requested?
              </Heading>
              <Text>
                ...
                Foundation will not be able to adequately contract with or
                employ you without certain personal data and you may not be able
                to exercise your contractor or employee rights if you do not
                provide the personal data requested. Although we cannot mandate
                you to share your personal data with us, please note that this
                then may have consequences which could affect your contractual
                relationship or employment in a negative manner, such as not
                being able to exercise your statutory rights or even to continue
                your contract or employment. Whenever you are asked to provide
                us with any personal data related to you, we will indicate which
                personal data is required, and which personal data may be
              ...
              <Text>
                For the use of your personal data for the purposes described
                above (in section 4), we rely on the following legal basis, as
                applicable:
              </Text>
              <UnorderedList>
                <VStack spacing="2.5" alignItems="left">
                  <ListItem>
                    ...
                    obligations in your contractor or employment contract with
                    us and similar collective contractor or employment
                    agreements, or as part of pre-contractual measures to
                    establish contractor-related or employment and related
                    contracts
                  </ListItem>
                  <ListItem>
                    In some cases, we rely on our legitimate interests to
                    process your personal data insofar as this is not overridden
                    by your own privacy interests. Such interests may include:
                    <UnorderedList>
                      <VStack spacing="2.5" mt="1rem">
                        ...
                        <ListItem>
                          ...
                          investigations of such activity, misuse of the
                          Developer DAO Foundation assets, products, and
                          services, and as strictly necessary and proportionate
                          for ensuring network and information security; and
                        </ListItem>
                        <ListItem>
                          ​​transmitting personal data within the Developer DAO
                          Foundation group for internal administrative purposes
                          as necessary, for example, to provide centralised
                          services.
                        </ListItem>
                      </VStack>
                    </UnorderedList>
                  ...
                  <ListItem>
                    ...
                    obligations with authorities or statutory retention periods
                    in order to carry out our contractual responsibilities as a
                  ...
                  <ListItem>
                    ...
                    purpose, we will remind you that you are free to withdraw
                    your consent at any time and we will tell you how you can do
                    this.
                  </ListItem>
                </VStack>
              </UnorderedList>
            ...
            <VStack mt="2.5rem" spacing="2.5" alignItems="left">
              ...
              <Text>
                ...
                reserves the right to immediately delete that information
                without informing you or to decide which category of data
                subject that you appear to be and manage your personal data
                within the remit of that category as described elsewhere in this
                Privacy Notice. We do not knowingly collect or solicit personal
                information from anyone under 18 years of age. If you are under
                18, please do not send any personal information about yourself
                to us.
              </Text>
              <Heading as="h3" fontSize="md">
              ...
              <UnorderedList>
                <VStack spacing="2.5" alignItems="left">
                  ...
                  <ListItem>
                    send you marketing communications (such as alerts,
                    promotional materials, newsletters, etc.);
                  </ListItem>
                  <ListItem>
              ...
              <Text>
                ...
                above purposes. We may also anonymise your personal data, so it
                no longer identifies you and use it for various purposes,
                including the improvement of our services and testing our IT
                systems.
              </Text>
              <Heading as="h4" fontSize="base">
              ...
              <Text>
                We reserve the right to restrict access to or remove material
                that we believe in good faith to be copyrighted material and/or
                illegally copied and/or distributed, and restrict and
                discontinue service to offenders. If you believe that material
                or content residing on or accessible through the Services
                infringes your copyright (or the copyright of someone on behalf
                of which you are authorized to act), please send a notice of
            ...
            <VStack mt="2.5rem" spacing="2.5" alignItems="left">
              ...
              <UnorderedList>
                <VStack spacing="2.5" alignItems="left">
                  ...
                  <ListItem>
                    Additional information you provide to us in the course of
                    our business relations such as data concerning the
                    fulfilment of our contractual obligations and
                    pre-contractual measures including correspondence data,
                    offers, tenders, resume/CV, conditions, contract and order
                    data, invoices, payments, business partner history, records
                    relating to queries/questions/complaints/orders.
                  </ListItem>
                  <ListItem>
                    ...
                    systems or applications and in accordance with the
                    applicable law) such as information technology usage (system
                    access, IT and internet usage), device identifier (mobile
                    device ID, PC ID), registration and login credentials, IP
                    address, login data and log files, Analytics ID, time and
                    URL, searches, website registration and cookie data, sound
                    recordings (e.g. voice mail/phone recordings, Skype
                    recordings).
                  </ListItem>
                </VStack>
              </UnorderedList>
              ...
              <Text>
                We may use your personal data as described above for the
                following purposes::
              </Text>
              <UnorderedList>
                <VStack spacing="2.5" alignItems="left">
                  <ListItem>
                    supplier and service provider management throughout the
                    supply chain including contact interaction including
                    tendering, engagement, processing orders, process and
                    fulfilment of purchases, administration and management of
                    suppliers, vendors, contractors, advisers and other
                  ...
                  <ListItem>
                    ...
                    preventing and detecting security threats, and fraud or
              ...
              <Text>
                We collect only the personal data from you that we need for the
                purposes described above. For statistical purposes, improvement
                of our services and testing of our IT systems we use as much as
              ...
              <Heading as="h4" fontSize="base">
                What happens if you do not provide us with the information we
                had asked you for or if you ask us to stop processing your
                information?
              </Heading>
              <Text>
                Where it concerns processing operations related to the
                agreements with our suppliers (as described above), the
                Developer DAO Foundation will not be able to adequately
                establish, conduct or terminate a business relationship with you
                or your company and generally perform the purposes described
                above without certain personal data. Although we cannot obligate
                you to share your personal data with us, please note that this
                then may have consequences which could affect the business
                relationship in a negative manner, such as not being able to
                take requested pre-contractual measures to enter into a contract
                with you or to establish and continue the business relationship
                you have asked for.
              </Text>
              <Heading as="h4" fontSize="base">
                The legal basis on which we use your personal data
              ...
              <Text>
                ...
                your company, or as part of pre-contractual measures we take;
              </Text>
              <Text>
                In some cases, we rely on our legitimate interests to process
                your personal data insofar as this is not overridden by your own
              ...
              <Text>
                In some cases, we process your personal data on the basis of
                legal obligations and statutory requirements, for example, on
                the basis of tax or reporting obligations, cooperation
                obligations with authorities, statutory retention periods or the
                disclosure of personal data within the scope of official or
                judicial measures may be required for the purposes of taking
                evidence, prosecution or enforcement of civil law claims.
              </Text>
              <Text>
                Regarding personal data concerning criminal convictions and
                offences, we will only process such data where such processing
                is permitted by applicable (local) law.
              </Text>
            </VStack>
            <Heading as="h2" fontSize="lg" mt="2.5rem">
            ...
            <VStack mt="2.5rem" spacing="2.5" alignItems="left">
              ...
              <UnorderedList>
                <VStack spacing="2.5" alignItems="left">
                  ...
                  <ListItem>
                    Additional information you provide to us in the course of
                    our business relations such as: interests in the Developer
                    DAO Foundation’s services or products, marketing
                    preferences, registration information provided at events,
                    fairs, contract or order data, invoices, payments, business
                    partner history, etc.
                  </ListItem>
                  <ListItem>
                    Information your browser makes available when you visit the
                  ...
                  <ListItem>
                    ...
                    legitimately transmitted by other third parties (e.g. a
                    credit agency): commercial register data, association
                    register data, creditworthiness data.
                  </ListItem>
                </VStack>
              </UnorderedList>
              <Heading as="h4" fontSize="base">
              ...
              <Text>
                ...
                terminate a business relationship with you. We need you to
                provide us with the personal data required for the fulfilment of
                contractual obligations or which we are legally obliged to
                collect. Without such personal data, we will not be able to
                establish, execute or terminate a contract with you. Also, we
                will be unable to take the requested pre-contractual measures to
                enter a contract with you or to establish and continue the
                business relationship you have asked for.
              </Text>
              <Heading as="h4" fontSize="base">
                The legal basis on which we use your personal data
              </Heading>
              ...
              <UnorderedList>
                <VStack spacing="2.5" alignItems="left">
                  ...
                  <ListItem>
                    We will ask your consent for the activities described in
                    this privacy notice when required by applicable law, for
                    example when we process your data for marketing purposes
                    where we don’t have an existing business relationship with
                  ...
                  <ListItem>
                    ...
                    with you or your company. Our legitimate interests to
                    collect and use the personal data for this purpose are
                    management and furtherance of our business. You may obtain a
                    copy of our assessment of why we may process your personal
                    data for these interests by submitting a request at
                    developerdaooperations@gmail.com.
                  </ListItem>
                </VStack>
              </UnorderedList>
