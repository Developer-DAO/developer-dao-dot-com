...
const fillHomePage = async (strapi) => {
  ...
  const partners = (
    await strapi.entityService.findMany('api::partner.partner', {
      limit: 5,
    })
  ...
  await strapi.entityService.update('api::home-page.home-page', homePageObject.id, {
    data: {
      ...
      sub_heading:
        'Developer DAO is a community of thousand of web3 builders creating a better internet. Join us and create the future.',
      news_ticker: [
        {
          name: 'membership',
